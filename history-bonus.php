...
<section class="container flex mx-auto lg:pt-3 lg:pb-5 lg:mt-5">
    ...
    <div class="w-full lg:w-2/3 lg:px-3 pb-20 md:pb-52">
        <div class="grid grid-cols-4 lg:mb-6 mt-4 lg:mt-0 pb-2 lg:pb-0 lg:gap-x-3 px-3 overflow-x-scroll">
            ...
            <a aria-label="Bonus-tab-button" aria-labelledby="Bonus-tab-button" class="text-sm border-b uppercase flex-none px-1 pb-2 justify-center cursor-pointer transition-all duration-300 ease-in-out hover:lg:border-primary hover:lg:text-inverse font-semibold border-primary" href="/history-bonus">Bonus</a>
        </div>
        <section class="mt-3 lg:px-4">
            <div class="lg:bg-background-secondary rounded-xl lg:py-4">
                <div class="px-4 pb-4 border-b border-separator">
                    <p class="text-xs lg:text-sm w-full mb-2">Riwayat Bonus untuk <?php echo htmlspecialchars($nama_pengguna_anggota); ?></p>
                </div>
                <div class="px-4 mt-4">
                    <div id="loading" class="mt-3 text-center">
                        <p class="text-gray-500">Memuat riwayat bonus...</p>
                    </div>
                    <div id="listContainer" class="px-4 my-4">
                        </div>
                </div>
            </div>
        </section>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Fungsi untuk mengambil dan menampilkan data bonus menggunakan AJAX
        function fetchBonusHistory() {
            loadingMessage.style.display = 'block';
            listContainer.innerHTML = '';
            
            fetch('ajax/get_history_bonus.php')
                .then(response => {
                    if (!response.ok) {
                ...
                .catch(error => {
                    ...
                    loadingMessage.style.display = 'none';
                    listContainer.innerHTML = '<p class="text-center mt-3 text-red-500">Gagal memuat data bonus. Silakan coba lagi.</p>';
                });
        }
