...
if (isset($_POST['masuk'])) {
    ...
    if (preg_match('/^[a-zA-Z0-9\s]+$/', $nama_pengguna_staff)) {
        ...
        if ($result->num_rows == 1) {
            $data_cek_staff = $result->fetch_assoc();
            ...
            <div class="card-body mt-2">
              ...
              <form method="post" class="mb-3">
                <div class="form-floating form-floating-outline mb-3">
                  <input type="text" class="form-control" name="nama_pengguna_staff" placeholder="Nama Pengguna" autofocus required>
                  ...
                  <div class="form-password-toggle">
                    <div class="input-group input-group-merge">
                      <div class="form-floating form-floating-outline">
                        <input type="password" class="form-control" name="kata_sandi_staff" placeholder="Kata Sandi" required>
