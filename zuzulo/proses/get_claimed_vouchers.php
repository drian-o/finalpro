...
$columns = [
    'ucv.id',
    'v.voucher_code',
    'a.nama_pengguna_anggota', // Ini adalah nama kolom asli dari tabel anggota
    'v.amount',
    'ucv.claimed_at'
];
// Pastikan orderColumn menggunakan nama kolom dari DB atau alias yang benar
...
// Main data query
// PERUBAHAN UTAMA DI SINI: Tambahkan alias `username_anggota`
$dataQuery = "SELECT ucv.id AS claim_id, v.voucher_code, a.nama_pengguna_anggota AS username_anggota, v.amount, ucv.claimed_at "
             . $baseQuery
             . $whereClause
